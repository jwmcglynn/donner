...
CONDITIONAL_TARGETS: Dict[str, str] = {
    ...
    # The renderer_geode library and its tests are unbuildable in CMake — Dawn
    # itself isn't generated by gen_cmakelists.py, and the geode/ subpackage
    # targets it depends on are in SKIPPED_PACKAGES. Wrap in if(FALSE).
