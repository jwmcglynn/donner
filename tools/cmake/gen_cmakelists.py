...
# Use bzlmod-aware queries since this repository relies on MODULE.bazel. The
# workspace file is intentionally omitted.
...
def generate_root() -> None:
    ...
    with path.open("w") as f:
        ...
        f.write(
            "execute_process(COMMAND bash -c \"${skia_SOURCE_DIR}/bin/gn gen ${skia_SOURCE_DIR}/out/cmake --ide=json --json-ide-script=${skia_SOURCE_DIR}/gn/gn_to_cmake.py --args='skia_use_gl=false skia_enable_tools=false is_skia_dev_build=false'\" WORKING_DIRECTORY ${skia_SOURCE_DIR})\n"
        )
