...
class SecurityWorkflowPolicyTest(unittest.TestCase):
    ...
    def test_release_only_verifies_retained_preflight_bytes_before_publication(self):
        ...
        self.assertEqual(release.count("gh attestation verify"), 3)
        self.assertEqual(release.count("--signer-workflow jwmcglynn/donner/.github/workflows/bcr_preflight.yml"), 3)
