...
class SecurityWorkflowPolicyTest(unittest.TestCase):
    ...
    def test_bcr_fork_preparation_requires_manual_approval_and_never_files_a_pr(self):
        ...
        generate, prepare = remainder.split("\n  prepare-fork:\n", 1)
        ...
        self.assertIn("PUBLISH_TOKEN: ${{ secrets.PUBLISH_TOKEN }}", prepare)
        ...
        self.assertIn("--force-with-lease=\"refs/heads/donner-${TAG}:\"", prepare)
        self.assertNotIn("git push --force", prepare)
        self.assertNotIn("/pulls", prepare)
