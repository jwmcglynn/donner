/// @file
/// Fixture tests for the v0.8 showcase assets (design doc:
/// `docs/design_docs/0047-v0_8_showcase.md` → `showcase_asset_tests`).
///
/// Two assets are validated:
///
///   - `donner_splash_v0_8_editable.svg`: the Milestone 1 editable intermediate.
///     This test (`EditableSplashParsesWithNonEmptyViewBox`) is the original
///     "fails loudly if the planned source asset is missing or invalid" gate and
///     stays in place across later milestones.
///   - `donner_splash_v0_8.svg`: the Milestone 8 FINAL outlined splash, produced
...
///     Viewport as SVG with overlay enabled). These tests assert the design
///     doc's final-asset invariants: it parses + renders in Donner, contains
