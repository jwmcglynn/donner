...
TEST(ViewportGeometryTest, ComputesCenteredLayoutWithPanOffset) {
  const DrawingViewportLayout layout = ComputeDrawingViewportLayout(
      Vector2d(20.0, 30.0), Vector2d(400.0, 300.0), Vector2d(100.0, 80.0), Vector2d(15.0, -10.0),
...
TEST(ViewportGeometryTest, ScreenToDocumentMapsViewBoxCorners) {
  const DrawingViewportLayout layout = ComputeDrawingViewportLayout(
      Vector2d(50.0, 75.0), Vector2d(300.0, 200.0), Vector2d(200.0, 100.0), Vector2d(0.0, 0.0),
...
TEST(ViewportGeometryTest, DocumentToScreenRoundTripsThroughViewBox) {
  const DrawingViewportLayout layout = ComputeDrawingViewportLayout(
      Vector2d(0.0, 0.0), Vector2d(640.0, 480.0), Vector2d(320.0, 160.0), Vector2d(-12.0, 18.0),
