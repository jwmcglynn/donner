/// @file
/// Generator for the v0.8 Donner showcase asset (Milestone 8 of
/// `docs/design_docs/0047-v0_8_showcase.md`).
///
/// Milestone 8 is described in the design doc as a GUI workflow ("open the base
...
///      the outlined `SVG` letters (the design doc's "overlay enabled" variant).
...
///
/// Keeping this a runnable tool (rather than a one-off manual GUI session) makes
/// the showcase reproducible for future releases, as the design doc requires.
