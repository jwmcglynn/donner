...
consteval bool ValidateSlugFillResources() {
  ...
  constexpr Expected buffers[] = {
      {"uniforms", BindingType::UniformBuffer, 416, 16, 0, ShaderScalarType::F32, 0},
...
consteval bool ValidateSlugFillArtifact() {
  constexpr SlugFillField fields[] = {
      ...
      {"instances", "_gridPad0", offsetof(SlugFillInstance, _gridPad0),
       sizeof(SlugFillInstance::_gridPad0), ShaderScalarType::U32, 1, 0, 0, 0, 0},
      {"instances", "_gridPad1", offsetof(SlugFillInstance, _gridPad1),
       sizeof(SlugFillInstance::_gridPad1), ShaderScalarType::U32, 1, 0, 0, 0, 0},
      ...
      {"instances", "_boundingPad0", offsetof(SlugFillInstance, _boundingPad0),
       sizeof(SlugFillInstance::_boundingPad0), ShaderScalarType::U32, 1, 0, 0, 0, 0},
      {"instances", "_boundingPad1", offsetof(SlugFillInstance, _boundingPad1),
       sizeof(SlugFillInstance::_boundingPad1), ShaderScalarType::U32, 1, 0, 0, 0, 0},
      {"instances", "_boundingPad2", offsetof(SlugFillInstance, _boundingPad2),
       sizeof(SlugFillInstance::_boundingPad2), ShaderScalarType::U32, 1, 0, 0, 0, 0},
