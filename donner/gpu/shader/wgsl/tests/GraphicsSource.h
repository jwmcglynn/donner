#pragma once
/// @file
/// A full-screen triangle with a smoothly interpolated UV interface.

#include "donner/gpu/shader/wgsl/Compiler.h"

namespace donner::gpu::shader::wgsl::tests {

/// Shared authored source for graphics compiler and native validation tests.
inline constexpr SourceText kGraphicsSource{R"wgsl(
struct Varyings {
