...
constexpr auto kArtifact =
    wgsl::Compile<programs::kComponentTransferSource, wgsl::Projection::All>();
constexpr CompiledShaderView kView = kArtifact.view();
static_assert(programs::ValidateComponentTransferArtifact<kView>());
constexpr auto kMutatedSource = ReplaceExact(
    ReplaceExact(ReplaceExact(ReplaceExact(ReplaceExact(programs::kComponentTransferSource,
                                                        "@binding(0)", "@binding(6)"),
                                           "@binding(1)", "@binding(5)"),
                              "@binding(2)", "@binding(4)"),
...
static_assert(programs::ValidateComponentTransferArtifact<kMutatedView>());
}  // namespace
