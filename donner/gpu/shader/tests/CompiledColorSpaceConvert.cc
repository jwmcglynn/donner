...
constexpr auto kArtifact =
    wgsl::Compile<programs::kColorSpaceConvertSource, wgsl::Projection::All>();
constexpr CompiledShaderView kView = kArtifact.view();
static_assert(programs::ValidateColorSpaceConvertArtifact<kView>());
constexpr auto kMutatedSource = ReplaceExact(
    ReplaceExact(
        ReplaceExact(ReplaceExact(ReplaceExact(ReplaceExact(programs::kColorSpaceConvertSource,
                                                            "@binding(0)", "@binding(6)"),
                                               "@binding(1)", "@binding(5)"),
                                  "@binding(2)", "@binding(4)"),
                     "@binding(3)", "@binding(7)"),
...
static_assert(programs::ValidateColorSpaceConvertArtifact<kMutatedView>());
}  // namespace
