...
constexpr auto kArtifact = wgsl::Compile<programs::kTileSource, wgsl::Projection::All>();
constexpr CompiledShaderView kView = kArtifact.view();
static_assert(programs::ValidateTileArtifact<kView>());
constexpr auto kMutatedSource = ReplaceExact(
    ReplaceExact(
        ReplaceExact(ReplaceExact(ReplaceExact(programs::kTileSource, "@binding(0)", "@binding(6)"),
                                  "@binding(1)", "@binding(5)"),
                     "@binding(2)", "@binding(4)"),
...
static_assert(programs::ValidateTileArtifact<kMutatedView>());
}  // namespace
