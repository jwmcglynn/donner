...
INSTANTIATE_TEST_SUITE_P(FiltersFilterFunctions, ImageComparisonTestFixture,
                         ValuesIn(getTestsInCategory("filters/filter-functions",
                                {
                                    {"blur-function-mm-value.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"blur-function-no-values.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"blur-function.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"color-adjust-functions-0percent.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"color-adjust-functions-100percent.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"color-adjust-functions-2.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"color-adjust-functions-200percent.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"color-adjust-functions-50percent.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"color-adjust-functions-default-value.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"color-adjust-functions-negative.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"drop-shadow-function-color-as-attribute.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"drop-shadow-function-color-last.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"drop-shadow-function-currentColor.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"drop-shadow-function-em-values.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"drop-shadow-function-filter-region.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"drop-shadow-function-mm-values.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"drop-shadow-function-no-color.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"drop-shadow-function-only-offset.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"drop-shadow-function.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"grayscale-and-opacity.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"hue-rotate-function-0.25turn.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"hue-rotate-function-45deg.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"hue-rotate-function-45grad.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"hue-rotate-function-45rad.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"hue-rotate-function-999deg.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"hue-rotate-function-default-value.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"hue-rotate-function-zero.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"two-exact-urls.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"two-urls.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                    {"url-and-grayscale.svg", Params::Skip("Bug: CSS filter function shorthand parses but is not applied at render")},
                                })),
                         TestNameFromFilename);
