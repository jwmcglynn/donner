...
/**
 * A compute pipeline built from a shader IR program, with the objects it is layered on.
 *
...
struct RuntimeComputeProgram {
  gpu::ShaderModule shaderModule;        //!< Module holding the `cs_main` entry point.
