...
gpu::Status GeodeWgpuAdapterDevice::onSubmit(
  ...
  // its queue can answer asynchronously. Native backends refuse a lost root before encoding or
  // recording in-flight work. This adapter remains only until the RHI dependency cutover.
