 ...
 * | `width`               | `0`             | The width of the symbol's viewport. A value of 0 indicates auto (interpreted as 100% when instantiated). |
 * | `height`              | `0`             | The height of the symbol's viewport. A value of 0 indicates auto (interpreted as 100% when instantiated). |
