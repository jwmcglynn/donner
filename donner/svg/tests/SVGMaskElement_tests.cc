...
TEST(SVGMaskElementTests, RenderingMaskUnitsAndContentUnits) {
  ...
  EXPECT_TRUE(generatedAscii.matchBackend()
        ...
        ...-*#%@@%#*-...
                  ...
                  // Vulkan coverage quantization differs by one ASCII bucket between the Arc
                  // hardware adapter and the hosted llvmpipe adapter. Accept the two exact full
                  // images so any geometry or broader coverage change still fails.
                  .geodeAlternative(R"(
        ..#@@#..........
        .@@@@@@.........
        #@@@@@@#........
