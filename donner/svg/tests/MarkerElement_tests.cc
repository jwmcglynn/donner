...
class MarkerElementTest : public ::testing::Test {
protected:
  void SetUp() override {
    document_ = std::make_unique<SVGDocument>();
...
TEST_F(MarkerElementTest, MarkerAttributes) {
...
TEST_F(MarkerElementTest, MarkerStartProperty) {
...
TEST_F(MarkerElementTest, MarkerMidProperty) {
...
TEST_F(MarkerElementTest, MarkerEndProperty) {
  auto polygon = SVGPolygonElement::Create(*document_);
  polygon.setPoints({{50, 50}, {250, 50}, {150, 150}, {250, 250}, {50, 250}});
