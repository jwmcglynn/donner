"""
Uses numpy to compute the high-precision path length of the PathLength testcases in path_spline_tests.cc

Run with: bazel run //src/svg/core:generate_test_pathlength_numpy
"""
