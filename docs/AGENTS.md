...
- Design docs: use templates under `docs/design_docs/` (`design_template.md` for in-flight, `developer_template.md` for shipped, `retrospective_template.md` for postmortems/reviews). See `docs/design_docs/AGENTS.md`.
