...
| 0039 | [text_editor_focus_and_flash](0039-text_editor_focus_and_flash.md)                         | Draft                                                  | Source-pane focus view, changed-character flash highlight, and context-aware soft wrap without horizontal scrolling.         |
