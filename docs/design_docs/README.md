...
| 0015   | skia_filter_conformance                                                                    | **Missing** — file does not exist                                 | Broken index reference; no `0015-*.md` file is present in this directory. Needs owner triage (recreate, or remove this row).               |
...
| 0020   | [editor](0020-editor.md)                                                                   | Implemented                                                       | Bringing `jwmcglynn/donner-editor` in-tree as `//donner/editor` (landed as M1–M8, #529; scope now exceeds original doc).                    |
...
| 0023   | [editor_sandbox](0023-editor_sandbox.md)                                                   | Implemented (Milestones S1–S4, S6); S5 not started                | Browser-style process isolation for the editor's parser / renderer.                                                                         |
...
| 0025   | [composited_rendering](0025-composited_rendering.md)                                       | Implementing (Phase 1 + 2.5 live; Phase 2 partial)                | Layer-based compositor for fluid editor dragging without full re-render. **Number collides with 0025-editor_ux — needs renumbering.**       |
| 0025   | [editor_ux](0025-editor_ux.md)                                                             | Implemented                                                       | Viewport zoom/pan/DPR, marquee multi-select, gestures, menu parity; superseded architecturally by the thin-client `EditorShell`. **Number collides with 0025-composited_rendering — needs renumbering.** |
| 0026   | [drag_end_latency](0026-drag_end_latency.md)                                               | Superseded by [0035](0035-filter_layer_compose_offset_bug.md)     | The shipped fix used a structural-remap path, not this doc's drop-reparse plan. **Number collides with 0026-svg_conformance_testing — needs renumbering.** |
| 0026   | [svg_conformance_testing](0026-svg_conformance_testing.md)                                 | Draft                                                             | Manifest-driven SVG 1.1 filter + WPT + scripted conformance program. **Number collides with 0026-drag_end_latency — needs renumbering.**    |
| 0027   | [tight_bounded_segments](0027-tight_bounded_segments.md)                                   | Implementing (M0/0.5/0.6 landed; M1–6 not started)                | Tight per-segment path bounds; `tightBoundedSegments` now defaults on. **Number collides with 0027-scripting — needs renumbering.**         |
| 0027   | [scripting](0027-scripting.md)                                                             | Draft                                                             | `donner::script`: QuickJS-NG + IDL codegen that projects the ECS as the DOM. **Number collides with 0027-tight_bounded_segments — needs renumbering.** |
| 0028   | [v1_0_release](0028-v1_0_release.md)                                                       | Draft — superseded as the next release by v0.8                    | Release checklist and implementation plan for shipping v1.0; `ProjectRoadmap.md` now targets v0.8 next. **Number collides with 0028-tinyskia_premul_internal — needs renumbering.** |
| 0028   | [tinyskia_premul_internal](0028-tinyskia_premul_internal.md)                               | Rejected proposal                                                 | Internal premultiplied-alpha representation for tiny-skia; rejected with rationale recorded. **Number collides with 0028-v1_0_release — needs renumbering.** |
| 0029   | [ci_runtime](0029-ci_runtime.md)                                                           | Superseded by [0031](0031-ci_hardening_2026q2.md)                 | CI runtime reduction plan (post-Skia baseline, per-config cache slots, runner sizing). Scope folded into 0031. **Number collides with 0029-ui_input_repro — needs renumbering.** |
| 0029   | [ui_input_repro](0029-ui_input_repro.md)                                                   | Implemented                                                       | Deterministic UI input recording/replay (Stage 1 + Stage 2 headless replay); backs the `gl_rnr_replay` CI golden suite. **Number collides with 0029-ci_runtime — needs renumbering.** |
...
| —      | [structured_text_editing](structured_text_editing.md)                                      | Implemented (flagged for Finalization pass)                       | Structured source editing (`XMLSourceStore`/`DocumentSyncController`); `structuredEditingEnabled_` defaults on. Not yet in this index — needs a number. |
| —      | [text_editor_behavior](text_editor_behavior.md)                                            | Living reference                                                  | Text editor behavior spec and known-bug tracker for the source editor. Not yet in this index — needs a number.                              |
| —      | [text_editor_refactor](text_editor_refactor.md)                                            | Mostly implemented                                                | `TextEditorCore` extraction plan (Commit 1 done, most of Commit 2 done; copy/cut/paste and final `TextEditor_tests.cc` split remain). Not yet in this index — needs a number. |
| —      | [text/overview](text/overview.md)                                                          | Implemented                                                       | Text rendering hub doc; corrected to reflect the removed full-Skia backend (TinySkia/Geode only). Not yet in this index.                    |
| —      | [text/architecture](text/architecture.md)                                                  | Historical                                                        | Text backend architecture notes, explicitly marked historical. Not yet in this index.                                                       |
| —      | [text/rtl_and_complex_scripts](text/rtl_and_complex_scripts.md)                            | Reference                                                         | RTL/complex-script shaping notes. Not yet in this index.                                                                                    |
| —      | [text/testing](text/testing.md)                                                            | Reference                                                         | Text test strategy; backend-parity section corrected to Geode vs TinySkia (was stale Skia vs TinySkia). Not yet in this index.              |
| —      | [text/text_backend_refactor](text/text_backend_refactor.md)                                | Reference                                                         | stb / FreeType+HarfBuzz backend tier split. Not yet in this index.                                                                          |
| —      | [text/text_v1_release](text/text_v1_release.md)                                            | Reference                                                         | Text v1 release checklist. Not yet in this index.                                                                                           |
| —      | [text/textpath](text/textpath.md)                                                          | Reference                                                         | `<textPath>` implementation notes. Not yet in this index.                                                                                   |
