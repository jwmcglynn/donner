...
| 0041-2 | [path_authoring_and_boolean_operations](0041-2-path_authoring_and_boolean_operations.md)   | Partially implemented                                             | Professional path authoring (Pen tool, boolean ops) and Donner-level boolean path operations for the editor; Path Edit tool not started. |
...
| 0056   | [geode_only_web_editor_runtime](0056-geode_only_web_editor_runtime.md)                     | In Progress                                                       | Single Geode WebGPU web editor package, analysis-time backend guard, and the cross-origin isolation the pthread build needs.                 |
