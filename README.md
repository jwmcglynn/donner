...
- Minimum compiler: Clang 18 with libc++ on macOS 26 and Ubuntu 24.04.
- macOS: the system toolchain on macOS 26 ships Clang 18. To force a matching
  Homebrew install, run:
