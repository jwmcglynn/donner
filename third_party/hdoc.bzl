...
cc_library(
    ...
    maybe(
        ...
        strip_prefix = "rapidjson-f9d53419e912910fd8fa57d5705fa41425428c35",
        urls = ["https://github.com/Tencent/rapidjson/archive/f9d53419e912910fd8fa57d5705fa41425428c35.tar.gz"],
        build_file_content = """
load("@rules_cc//cc:defs.bzl", "cc_library")
