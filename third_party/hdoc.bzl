...
cc_library(
    ...
    maybe(
        ...
        urls = ["https://github.com/gabime/spdlog/archive/v1.14.1.tar.gz"],
        build_file_content = """
load("@rules_cc//cc:defs.bzl", "cc_library")
...
cc_library(
    ...
    maybe(
        ...
        urls = ["https://github.com/Tencent/rapidjson/archive/ab1842a2dae061284c0a62dca1cc6d5e7e37e346.tar.gz"],
        build_file_content = """
load("@rules_cc//cc:defs.bzl", "cc_library")
