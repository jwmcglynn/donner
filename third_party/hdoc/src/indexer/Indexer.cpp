...
bool isChild(const hdoc::types::Symbol& ns, const hdoc::types::Symbol& s) {
...
void hdoc::indexer::Indexer::run() {
  ...
  auto cmpdb = clang::tooling::JSONCompilationDatabase::loadFromFile(this->cfg->compileCommandsJSON.string(), err, stx);
  ...
  hdoc::indexer::ParallelExecutor tool(*cmpdb,
                                       includePaths,
                                       this->cfg->ignorePaths,
                                       this->cfg->rootDir,
                                       this->pool,
                                       this->cfg->debugLimitNumIndexedFiles);
