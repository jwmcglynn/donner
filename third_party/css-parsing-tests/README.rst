...
based on the 2019 recommendation of the `CSS Syntax Level 3`_ specification.

.. _CSS Syntax Level 3: https://www.w3.org/TR/css-syntax-3/
...
``component_value_list.json``
    ...
    <https://www.w3.org/TR/css-syntax-3/#parse-a-list-of-component-values>`_.
...
``stylesheet_bytes.json``
    ...
    <https://www.w3.org/TR/css-syntax-3/#input-byte-stream>`_.
...
``An+B.json``
    Tests the `An+B <https://www.w3.org/TR/css-syntax-3/#the-anb-type>`_
    syntax defined in CSS Syntax Level 3.
    This `differs <https://www.w3.org/TR/css-syntax-3/#changes>`_ from the
