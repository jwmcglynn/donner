...
#include <GLFW/glfw3.h> // NOLINT(banned_patterns: vendored GLFW keyboard mapping)
...
static_assert(keyboardEventCodeToScancode("KeyI") == DOM_PK_I);
static_assert(scancodeToKeyCode(DOM_PK_I) == GLFW_KEY_I);
static_assert(keyCodeToScancode(GLFW_KEY_I) == DOM_PK_I);
