...
#include "tiny_skia/wide/backend/WasmSimd128F32x8T.h"
...
[[nodiscard]] constexpr bool useWasmSimd128F32x8() {
...
F32x8T F32x8T::floor() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Floor(lanes_));
  }
...
I32x8T F32x8T::toI32x8Bitcast() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return I32x8T(backend::wasm_simd128::f32x8ToI32Bitcast(lanes_));
  }
...
U32x8T F32x8T::toU32x8Bitcast() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return U32x8T(backend::wasm_simd128::f32x8ToU32Bitcast(lanes_));
  }
...
F32x8T F32x8T::cmpEq(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8CmpEq(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::cmpNe(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8CmpNe(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::cmpGe(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8CmpGe(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::cmpGt(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8CmpGt(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::cmpLe(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8CmpLe(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::cmpLt(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8CmpLt(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::blend(const F32x8T& t, const F32x8T& f) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Blend(lanes_, t.lanes_, f.lanes_));
  }
...
F32x8T F32x8T::abs() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Abs(lanes_));
  }
...
F32x8T F32x8T::sqrt() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Sqrt(lanes_));
  }
...
F32x8T F32x8T::recipFast() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8RecipFast(lanes_));
  }
...
F32x8T F32x8T::recipSqrt() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8RecipSqrt(lanes_));
  }
...
F32x8T F32x8T::max(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Max(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::min(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Min(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::round() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Round(lanes_));
  }
...
I32x8T F32x8T::roundInt() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return I32x8T(backend::wasm_simd128::f32x8RoundInt(lanes_));
  }
...
I32x8T F32x8T::truncInt() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return I32x8T(backend::wasm_simd128::f32x8TruncInt(lanes_));
  }
...
F32x8T F32x8T::operator+(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Add(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::operator-(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Sub(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::operator*(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Mul(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::operator/(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8Div(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::operator&(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8BitAnd(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::operator|(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8BitOr(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::operator^(const F32x8T& rhs) const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8BitXor(lanes_, rhs.lanes_));
  }
...
F32x8T F32x8T::operator~() const {
  ...
  if constexpr (useWasmSimd128F32x8()) {
    return F32x8T(backend::wasm_simd128::f32x8BitNot(lanes_));
  }
